...
if __name__ == "__main__":
    ...
    split_dataset(input_json=os.path.join(src_data_root, "train/label/Train_Resize.json"),
    ...
    for i in split_train_data_list['images']:
        try:
            shutil.copy(os.path.join(src_data_root, "train/images/"+i['file_name']), os.path.join(dest_data_root, "train_img/"+i['file_name']))
        except:
            pass

    for i in split_val_data_list['images']:
        try:
            shutil.copy(os.path.join(src_data_root, "train/images/"+i['file_name']), os.path.join(dest_data_root, "val_img/"+i['file_name']))
        except:
            pass
